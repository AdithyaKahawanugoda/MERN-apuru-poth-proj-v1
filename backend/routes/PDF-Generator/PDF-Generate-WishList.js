...
router.post("/generatewishlist", async (req, res) => {
//load cuurent time
...
seconds;
 ...
 const wishlistReport = req.body.wishlist;
...
const table = {
headers: ["Item Code", "Book Name", "Price"],
rows: [],
};

 for (const wishlistitem of wishlistReport) {
  table.rows.push([
    wishlistitem._id,
