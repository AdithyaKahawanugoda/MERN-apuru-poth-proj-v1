...
const Inventory = () => {
  ...
  const demoFunction = (e) => {
    ...
    setOriginalTitle("Demo Original Book Title");
    ...
    setQuantity(2500);
    setEdition(2);
    setTranslatorContact(1771234568);
    setPress("Demo Press Name");
    setProofReader("Demo Proof Reader Name");
    setCoverDesigner("Demo Cover Designer");
    setTypeSetter("Demo Type Setter");
    setWeight(250);
    setMarketPrice(900);
    setCoverCost(8000);
    setLicenseCost(68000);
